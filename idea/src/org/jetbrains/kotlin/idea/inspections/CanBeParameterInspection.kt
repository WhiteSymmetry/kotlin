...
class CanBeParameterInspection : AbstractKotlinInspection() {
    private fun PsiReference.usedAsPropertyIn(klass: KtClass): Boolean {
        ...
        val parameterUser = PsiTreeUtil.getParentOfType(nameExpression, KtProperty::class.java, KtPropertyAccessor::class.java,
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : KtVisitorVoid() {
            ...
            override fun visitParameter(parameter: KtParameter) {
                ...
                val constructor = parameter.getStrictParentOfType<KtPrimaryConstructor>() ?: return
                val klass = constructor.getStrictParentOfType<KtClassOrObject>() as? KtClass ?: return
    ...
    class RemoveValVarFix(val parameter: KtParameter) : LocalQuickFix {
        ...
        override fun applyFix(project: Project, descriptor: ProblemDescriptor) {
            ...
            parameter.visibilityModifier()?.delete()
            parameter.modalityModifier()?.delete()
        }
    }
}
