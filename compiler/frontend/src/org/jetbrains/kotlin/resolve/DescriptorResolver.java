...
public class DescriptorResolver {
    ...
    private KotlinType determineGetterReturnType(
        ...
        // If a property has no type specified in the PSI but the getter does ("val x get() = ..."),
        ...
        if (getter.hasBody() && !getter.hasBlockBody() &&
            !property.hasDelegateExpressionOrInitializer() && property.getTypeReference() == null) {
